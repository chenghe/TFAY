...
public class LaunchShareCircleActivity extends RootActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		}else if((MXConstants.Share.MXKIT_INTENT_ACTION_SHARE.equals(action) ||  MXConstants.Share.MXKIT_INTENT_ACTION_SHARE_CIRCLE.equals(action) )&& type != null){
	...
	private void handleMXShare(Intent intent) {
		...
		if (currentUser != null) {
			...
			intent.putExtra(MXConstants.Share.MXKIT_INTENT_SHARE_APP_NAME, appName);
